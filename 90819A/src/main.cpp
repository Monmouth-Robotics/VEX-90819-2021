...
lv_obj_t* text = lv_label_create(lv_scr_act(), NULL); /*Add a button the current screen*/
...
void competition_initialize()
{
	...
	lv_btn_set_action(btn1, LV_BTN_ACTION_CLICK, btn1_action); /*Assign a callback to the button*/
	...
	lv_btn_set_action(btn2, LV_BTN_ACTION_CLICK, btn2_action); /*Assign a callback to the button*/
	...
	lv_btn_set_action(btn3, LV_BTN_ACTION_CLICK, btn3_action); /*Assign a callback to the button*/
	...
	lv_btn_set_action(btn4, LV_BTN_ACTION_CLICK, btn4_action); /*Assign a callback to the button*/
	...
	lv_btn_set_action(btn5, LV_BTN_ACTION_CLICK, btn5_action); /*Assign a callback to the button*/
	...
	lv_btn_set_action(btn6, LV_BTN_ACTION_CLICK, btn6_action); /*Assign a callback to the button*/
