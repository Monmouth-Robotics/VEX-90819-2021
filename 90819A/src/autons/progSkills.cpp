...
{	
	...
	ppMove({{0, 0, 0}, {15, 0, 0}}, 1, 0.00, 0.00, 0.001, 5.0, 10.0, 3.0, 10, 0.25, 25, 300, 0.008);
	ppMove({{15, 0, 0}, {15, 22, 0}, {9, 41, -M_PI/4}}, 1, 0.00, 0.00, 0.001, 5.0, 10.0, 3.0, 10, 0.25, 25, 300, 0.008);
