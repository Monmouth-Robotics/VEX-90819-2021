...
void firstGoal()
{
	...
	PathFollowing()
		...
		.ppMove();
	PathFollowing()
		.withPath({{27, 47, 0}, {14, 37, -M_PI / 4}, {4, 44, -M_PI / 4}}, 1)
		.ppMove();
	...
	// (0, 0)(0, 13)(0, 13)(13, 17)(13, 17)(27, 47)(27, 47)(9, 41)(9, 41)(5, 45.5)
}
...
{
	PathFollowing()
		.withPath({{65, 41, 0}, {63, 28, 0}, {91, 48, M_PI / 4}}, 1)
		.ppMove();
	PathFollowing()
		.withPath({{91, 48, M_PI / 4}, {110, 40, M_PI / 4}, {118, 48, M_PI / 4}}, 1)
		.ppMove();
	// leftBackMotor = -63;
	// leftFrontMotor = -63;
	// rightFrontMotor = -63;
